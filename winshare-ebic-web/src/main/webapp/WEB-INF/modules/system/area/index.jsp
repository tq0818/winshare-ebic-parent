...
<head>
	...
	<script type="text/javascript">
		function refresh(){//刷新	
			window.location="${ctx}/system/area/index";
		}
	</script>
</head>
<body class="gray-bg">
	...
	<div id="content" class="row">
		...
		<div id="right"  class="col-sm-11  animated fadeInRight">
			<iframe id="areaContent" name="areaContent" src="${ctx}/system/area/list?id=&parentIds=" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
	</div>
	</div>
	<script type="text/javascript">
		...
		var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
			...
			callback:{onClick:function(event, treeId, treeNode){
					...
					$('#areaContent').attr("src","${ctx}/system/area/findChildren?id="+id);
				}
			}
		};
		
		function refreshTree(){
			$.getJSON("${ctx}/system/area/treeData",function(data){
