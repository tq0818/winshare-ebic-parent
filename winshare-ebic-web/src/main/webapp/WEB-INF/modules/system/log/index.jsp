...
<head>
	...
	<script type="text/javascript">
		function refresh(){//刷新	
			window.location="${ctx}/system/log/index";
		}
	</script>
</head>
<body class="gray-bg">
	...
	<div id="content" class="row">
		...
		<div id="right"  class="col-sm-11  animated fadeInRight">
			<iframe id="logContent" name="logContent" src="${ctx}/system/sysLog/list?id=&parentIds=" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
	</div>
	</div>
		...
		var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
			...
			callback:{onClick:function(event, treeId, treeNode){
				...
				zTree.updateNode(treeNode); 
					$('#logContent').attr("src","${ctx}/system/sysLog/list?orgId="+treeNode.id);
				}
			}
		};
