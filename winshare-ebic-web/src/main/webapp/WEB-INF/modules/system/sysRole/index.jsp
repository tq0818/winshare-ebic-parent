...
<head>
	...
	<script type="text/javascript">
		function refresh(){//刷新	
			window.location="${ctx}/system/sysRole/index";
		}
	</script>
</head>
<body class="gray-bg">
	...
	<div id="content" class="row">
		...
		<div id="right"  class="col-sm-11  animated fadeInRight">
			<iframe id="sysRoleContent" name="sysRoleContent" src="${ctx}/system/sysRole/list?id=&parentIds=" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
	</div>
	</div>
