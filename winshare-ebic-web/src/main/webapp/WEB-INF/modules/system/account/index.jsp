...
<head>
	...
	<script type="text/javascript">
		function refresh(){//刷新	
			window.location="${ctx}/system/account/index";
		}
	</script>
</head>
<body class="gray-bg">
	...
	<div id="content" class="row">
		...
		<div id="right"  class="col-sm-11  animated fadeInRight">
			<iframe id="accountContent" name="accountContent" src="${ctx}/system/account/list?orgInfo.id=" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
	</div>
	</div>
	<script type="text/javascript">
	var currNode = "";
	var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}}, view: {
        fontCss: function (treeId, treeNode) {
			...
			callback:{onClick:function(event, treeId, treeNode){
			        ...
			        $('#accountContent').attr("src","${ctx}/system/account/list?orgInfo.id="+id);
				}
			}
		};
