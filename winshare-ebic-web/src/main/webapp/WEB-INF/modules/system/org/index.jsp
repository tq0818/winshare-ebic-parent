...
<head>
	...
	<script type="text/javascript">
		function refresh(){//刷新	
			window.location="${ctx}/system/org/index";
		}
	</script>
</head>
<body class="gray-bg">
	...
	<div id="content" class="row">
		...
		<div id="right"  class="col-sm-11  animated fadeInRight">
			<iframe id="orgContent" name="orgContent" src="${ctx}/system/org/list?id=&parentIds=&" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
	</div>
	</div>
	<script type="text/javascript">
		...
		var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
			...
			callback:{onClick:function(event, treeId, treeNode){
					...
					$('#orgContent').attr("src","${ctx}/system/org/list?parentId="+treeNode.id+"&orgId="+treeNode.id+"&parentIds="+treeNode.pIds+treeNode.id);
				}
			}
		};
