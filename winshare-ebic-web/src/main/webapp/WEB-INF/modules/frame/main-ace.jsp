...
<head>
	...
	<%@ include file="/WEB-INF/include/acehead.jsp"%>
...
<body class="no-skin">
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="${ctxStatic}/common/img/a6.jpg" alt="Jason's Photo" />
		...
		<div class="main-container" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive">
				...
				<t:menu mainStyle="ace" isRoot="true"></t:menu>
				...
				<div class="footer-inner">
					...
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">winshare</span>
							 &copy; 2016-2025
						</span>
