...
<link href="${ctxStatic}/common/winshare.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/winshare.js" type="text/javascript"></script>
...
<link href="${ctxStatic}/common/css/choicebox.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/choicebox.js" type="text/javascript"></script>
<!-- tab页插件 -->
<script src="${ctxStatic}/tab/tab.js" type="text/javascript"></script>

<!-- 表单验证插件 -->
<script src="${ctxStatic}/validate/customValidate.js"></script>
